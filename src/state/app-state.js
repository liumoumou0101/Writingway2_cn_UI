...
function createAppState() {
    return {
        ...
        selectedRewritePresetId: 'balanced-polish',
        selectedRewritePromptId: null,
        showRegenerateSelectionModal: false,
        regenerateSelectionOriginalText: '',
        regenerateSelectionOutput: '',
        regenerateSelectionInstruction: '',
        regenerateSelectionUseContext: true,
        regenerateSelectionInProgress: false,
        regenerateSelectionTextareaStart: null,
        regenerateSelectionTextareaEnd: null,
        regenerateSelectionContextBefore: '',
        regenerateSelectionContextAfter: '',
